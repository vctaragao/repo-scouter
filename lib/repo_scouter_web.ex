defmodule RepoScouterWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: RepoScouterWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/repo_scouter_web/templates",
        namespace: RepoScouterWeb
  ...
  defp view_helpers do
    quote do
      ...
      import RepoScouterWeb.ErrorHelpers
      alias RepoScouterWeb.Router.Helpers, as: Routes
    end
  end
